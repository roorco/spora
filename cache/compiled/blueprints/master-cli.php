...
return [
    ...
    'timestamp' => 1626562715,
    'checksum' => '073c6ea391971d3aa15f89a79db77049',
    'files' => [
        ...
        'user/themes' => [
            ...
            'themes/spora' => [
                'file' => 'user/themes/spora/blueprints.yaml',
                'modified' => 1626535248
            ],
            'themes/sporspora' => [
                'file' => 'user/themes/sporspora/blueprints.yaml',
                'modified' => 1626538808
            ]
        ]
    ],
    'data' => [
        'items' => [
            ...
            'themes.spora.dropdown' => [
                'type' => '_parent',
                'name' => 'themes.spora.dropdown',
                'form_field' => false
            ],
            'themes.spora.dropdown.enabled' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.spora.dropdown.enabled',
                'validation' => 'loose'
            ],
            'themes.spora.production' => [
                'type' => 'toggle',
                'label' => 'Production Mode',
                'highlight' => 1,
                'default' => 1,
        ...
        'nested' => [
            ...
            'themes' => [
                ...
                'spora' => [
                    'dropdown' => [
                        'enabled' => 'themes.spora.dropdown.enabled'
                    ],
                    'production' => 'themes.spora.production'
                ],
                'sporspora' => 'themes.sporspora'
            ]
        ],
        'dynamic' => [
